...
const Sidebar = () => {
  ...
  return (
    ...
    <div className='  bg-gray-50 w-56 overflow-y-scroll h-screen mt-[50px] fixed z-50'>
...
//           <ul className="m-1">
//             <Link to={"/"}>
//               <li className="flex flex-row my-auto gap-x-3 p-1 font-semibold cursor-pointer">
//                 <IoHome className="my-auto" />Home
//               </li>
//             </Link>
//             <li className="flex flex-row my-auto gap-x-3 p-1 font-semibold cursor-pointer">
//               <SiYoutubeshorts className="my-auto" /> Shorts
//             </li>
//             <li className="flex flex-row my-auto gap-x-3 p-1 font-semibold cursor-pointer">
//               <MdSubscriptions className="my-auto" /> Subscriptions
//             </li>
//           </ul>
//         </div>
...
//           <ul className="m-1">
//             <li className="flex flex-row my-auto gap-x-3 p-1 font-semibold cursor-pointer">
//               <BiSolidUserAccount className="my-auto" />Your channel
//             </li>
//             <li className="flex flex-row my-auto gap-x-3 p-1 font-semibold cursor-pointer">
//               <BiLike className="my-auto" />Your likes
//             </li>
//             <li className="flex flex-row my-auto gap-x-3 p-1 font-semibold cursor-pointer">
//               <MdDownload className="my-auto" />Downloads
//             </li>
//             <li className="flex flex-row my-auto gap-x-3 p-1 font-semibold cursor-pointer">
//               <MdPlaylistPlay className="my-auto" />Playlists
//             </li>
//           </ul>
//         </div>
...
//           <ul className="m-1">
//             <li className="flex flex-row my-auto gap-x-3 p-1 font-semibold cursor-pointer">
//               <SiTrendmicro className="my-auto" />Trending
//             </li>
//             <li className="flex flex-row my-auto gap-x-3 p-1 font-semibold cursor-pointer">
//               <MdOutlineShoppingBag className="my-auto" />Shopping
//             </li>
//             <li className="flex flex-row my-auto gap-x-3 p-1 font-semibold cursor-pointer">
//               <MdLibraryMusic className="my-auto" />Your Music
//             </li>
//             <li className="flex flex-row my-auto gap-x-3 p-1 font-semibold cursor-pointer">
//               <CiStreamOn className="my-auto" />Live
//             </li>
//           </ul>
//         </div>
//       </div>
